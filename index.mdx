...
<style>{`
  ...
  /* Override dark mode background to complement purple theme */
  [data-theme="dark"],
  [class*="dark"],
  html[class*="dark"],
  body[class*="dark"] {
  ...
  /* Ensure main content area uses the dark purple background in dark mode */
  [data-theme="dark"] main,
  [data-theme="dark"] [class*="main"],
  [class*="dark"] main,
  [class*="dark"] [class*="main"] {
    background-color: #1a1625 !important;
    background: #1a1625 !important;
  }
  
  /* Override any black backgrounds in dark mode */
  [data-theme="dark"] *,
  [class*="dark"] * {
    --mint-bg: #1a1625 !important;
  }
  
  /* Ensure white sections adapt to dark mode */
  [data-theme="dark"] div[style*="backgroundColor: 'white'"],
  [class*="dark"] div[style*="backgroundColor: 'white'"] {
    background-color: #1f1b2e !important;
    border-color: #2d2440 !important;
  }
  
  /* Update text colors in dark mode for better contrast */
  [data-theme="dark"] p[style*="color: '#64748b'"],
  [class*="dark"] p[style*="color: '#64748b'"] {
